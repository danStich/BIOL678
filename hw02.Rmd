...
**Question 8**. Using this new data set, calculate the mean `do_mgl` in years were present or absent. There are a number of ways to do this. If you are struggling have a look at the examples using `group_by` and `summarize` from the `dplyr` package in [Chapter 3.4](https://danstich.github.io/worst-r/3-4-better-data-summaries.html)
...
**Question 10**. Based on your box plot, and your answer to Question 8, do you think these groups are different? Note, I am still not asking you to do any statistical tests yet. I just want you to think about the kinds of comparisons we will make in a couple weeks.
